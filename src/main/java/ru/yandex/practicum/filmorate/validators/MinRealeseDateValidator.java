...
public class MinRealeseDateValidator implements ConstraintValidator<MinRealeseDate, LocalDate> {

    private LocalDate minDate;

    @Override
    public void initialize(MinRealeseDate constraintAnnotaition) {
